...
if (empty($id)) {
    $sql = "SELECT id FROM tennis_booking ORDER BY id DESC LIMIT 1";
...
if (!empty($id)) {
    $stmt = $conn->prepare("SELECT * FROM tennis_booking WHERE id = ?");
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $field_name = $data['field']; // Menggunakan 'field' yang umum digunakan di database alih-alih 'fieldChoice'
          ...
          <div class="card-body p-4">
            ...
            <div class="mb-4">
              ...
              <form id="paymentConfirmForm" action="upload_payment_proof.php" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="booking_type" value="tennis">
      ...
      const timer = setInterval(() => {
        if (seconds === 0) {
          if (minutes === 0) {
            ...
            window.location.href = 'tennis_booking.php';
            return;
          }
          minutes--;
          seconds = 59;
