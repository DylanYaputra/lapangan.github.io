...
function getPendingPayments($conn) {
    ...
    // Ambil dari tabel futsal_booking
    $futsal_query = "SELECT b.*, 'futsal' as field_type, f.price_per_hour 
    ...
    // Ambil dari tabel tennis_booking
    $tennis_query = "SELECT b.*, 'tennis' as field_type, f.price_per_hour 
                    FROM tennis_booking b 
                    LEFT JOIN fields f ON b.field = f.$field_name_column 
                    WHERE b.status = 'pending_confirmation'";
