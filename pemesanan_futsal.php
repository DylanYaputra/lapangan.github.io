...
// Harga dan biaya - Set default price
$field_price = 100000; // Default price khusus untuk futsal
$admin_fee = 2500;
...
if (isset($_POST['submit_booking']) || isset($_SESSION['booking_data'])) {
    ...
    // Ambil harga dari database untuk field_name yang diupdate
    $query_price = "SELECT price_per_hour FROM fields WHERE field_name = ?";
    $stmt_price = $conn->prepare($query_price);
    if ($stmt_price) {
        $stmt_price->bind_param("s", $field_name);
        ...
        <div class="col-lg-8 mb-4">
          <div class="custom-card shadow-sm">
            ...
            <div class="card-body p-4">
              ...
              <form method="POST" action="konfirmasi_pembayaran_futsal.php">
