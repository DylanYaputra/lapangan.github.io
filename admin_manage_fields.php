...
if (isset($_GET['delete_id']) && !empty($_GET['delete_id'])) {
    ...
    $tables = ['futsal_booking', 'badminton_booking', 'tennis_booking'];
    $in_use = false;
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="field_type" name="field_type" required>
                                    ...
                                    <option value="futsal" <?php echo (isset($edit_data[$type_col]) && $edit_data[$type_col] == 'futsal') ? 'selected' : ''; ?>>Futsal</option>
                                    <option value="badminton" <?php echo (isset($edit_data[$type_col]) && $edit_data[$type_col] == 'badminton') ? 'selected' : ''; ?>>Badminton</option>
                                    <option value="tennis" <?php echo (isset($edit_data[$type_col]) && $edit_data[$type_col] == 'tennis') ? 'selected' : ''; ?>>Tennis</option>
                                </select>
                            </div>
