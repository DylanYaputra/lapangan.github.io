        ...
        <div class="container-fluid">
            ...
            <header class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-outline-secondary dropdown-toggle" type="button" id="fieldTypeDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            Pilih Lapangan
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="fieldTypeDropdown">
                            <li><a class="dropdown-item" href="#" onclick="showField('Futsal')">Futsal</a></li>
                            <li><a class="dropdown-item" href="#" onclick="showField('Badminton')">Bulu Tangkis</a></li>
                            <li><a class="dropdown-item" href="#" onclick="showField('Tenis')">Tenis</a></li>
                        </ul>
                    </div>
                </div>
            </header>
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <h5 class="mb-2 fw-bold">Lapangan Futsal</h5>
                                    <div class="d-flex gap-4">
                                        <div>
                                            <div class="text-muted">Total Lapangan</div>
                                            <div class="fs-4 fw-bold"><?php echo $total_futsal; ?></div>
                                </div>
                                <div>
                                            <div class="text-muted">Tersedia</div>
                                            <div class="fs-4 fw-bold text-success"><?php echo $available_futsal; ?></div>
                                </div>
                                <div>
                                            <div class="text-muted">Terpakai</div>
                                            <div class="fs-4 fw-bold text-danger"><?php echo $occupied_futsal; ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <h5 class="mb-2 fw-bold">Lapangan Tenis</h5>
                                    <div class="d-flex gap-4">
                                        <div>
                                            <div class="text-muted">Total Lapangan</div>
                                            <div class="fs-4 fw-bold"><?php echo $total_tennis; ?></div>
                                </div>
                                <div>
                                            <div class="text-muted">Tersedia</div>
                                            <div class="fs-4 fw-bold text-success"><?php echo $available_tennis; ?></div>
                                </div>
                                <div>
                                            <div class="text-muted">Terpakai</div>
                                            <div class="fs-4 fw-bold text-danger"><?php echo $occupied_tennis; ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2 class="fs-4 fw-semibold mb-0" id="fieldTitle">
                            <i class="fas fa-map-marker-alt me-2 text-green"></i>
                            Layout Lapangan - Futsal
                        </h2>
                        <div class="d-flex gap-4">
                            <div class="d-flex align-items-center">
                                <div class="d-inline-block bg-success rounded me-2" style="width: 16px; height: 16px;"></div>
                                <span>Tersedia</span>
                            </div>
                            <div class="d-flex align-items-center">
                                <div class="d-inline-block bg-danger rounded me-2" style="width: 16px; height: 16px;"></div>
                                <span>Terpakai</span>
                            </div>
                            <div class="d-flex align-items-center">
                                <div class="d-inline-block bg-warning rounded me-2" style="width: 16px; height: 16px;"></div>
                                <span>Reservasi</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Field Layout -->
                    <div class="field-layout mb-4" id="fieldLayout">
                        <?php 
                        // Tampilkan lapangan futsal
                        foreach ($futsal_fields as $index => $field): 
                            $field_status = "available";
                            $status_text = "Tersedia";
                            $status_class = "field-slot-available";
                            $field_name = isset($field[$name_column]) ? $field[$name_column] : $field['name'];
                            
                            // Cek apakah lapangan sedang digunakan
                            $field_check = isFieldCurrentlyOccupied($field_name, $todays_bookings);
                            if ($field_check['occupied']) {
                                $field_status = "occupied";
                                $status_text = "Terpakai hingga " . date('H:i', strtotime($field_check['end_time']));
                                $status_class = "field-slot-occupied";
                            } elseif ($field['status'] == 'maintenance') {
                                $field_status = "maintenance";
                                $status_text = "Pemeliharaan";
                                $status_class = "field-slot-occupied";
                            } elseif ($field['status'] == 'reserved') {
                                $field_status = "reserved";
                                $status_text = "Reservasi";
                                $status_class = "field-slot-reserved";
                            }
                        ?>
                        <div class="field-slot <?php echo $status_class; ?>">
                            <div class="field-slot-label">Futsal <?php echo str_pad($index + 1, 2, '0', STR_PAD_LEFT); ?></div>
                            <i class="fas fa-futbol fa-2x"></i>
                            <div class="field-info"><?php echo $status_text; ?></div>
                        </div>
                        <?php endforeach; ?>
                        </div>
                </div>
            ...
            <!-- Dashboard Layout - Updated to make all three columns equal size -->
            <div class="row g-8">
                <!-- Booking Terbaru Column -->
                <div class="col-md-6">
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                <?php foreach ($recent_bookings as $booking): 
                                    ...
                                    $is_today = ($booking_date == date('Y-m-d')) ? true : false;
                                    $status_badge = '';
