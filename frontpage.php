...
$futsal_count = $badminton_count = $tennis_count = 0;
if ($fields_result && $fields_result->num_rows > 0) {
    while ($field = $fields_result->fetch_assoc()) {
        if ($field['field_type'] == 'futsal') $futsal_count++;
        else if ($field['field_type'] == 'badminton') $badminton_count++;
        else if ($field['field_type'] == 'tennis') $tennis_count++;
    }
      ...
      <div class="row g-4">
        <div class="col-md-4">
          <div class="sport-card">
            ...
            <h4>Tenis</h4>
            <p>
              Lapangan tenis dengan standar internasional dan fasilitas lengkap
            </p>
        ...
        <div class="col-md-4">
          <div class="sport-card">
            ...
            <h4>Futsal</h4>
            <p>
              Rasakan sensasi bermain futsal dengan rumput sintetis berkualitas
            </p>
            <a href="#" class="btn btn-primary"
              >Pesan Lapangan</a
            >
