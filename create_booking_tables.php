...
if ($check_futsal->num_rows == 0) {
    ...
    if ($result) {
        echo "Tabel futsal_booking berhasil dibuat<br>";
    } else {
        $success = false;
    }
} else {
    echo "Tabel futsal_booking sudah ada<br>";
    // Tambahkan kolom user_id jika belum ada
    addUserIdColumn($conn, 'futsal_booking');
}
...
if ($check_tennis->num_rows == 0) {
    ...
    if ($result) {
        echo "Tabel tennis_booking berhasil dibuat<br>";
    } else {
        $success = false;
    }
} else {
    echo "Tabel tennis_booking sudah ada<br>";
    // Tambahkan kolom user_id jika belum ada
    addUserIdColumn($conn, 'tennis_booking');
}
