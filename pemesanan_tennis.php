...
// Harga dan biaya
$field_price = 100000; // Default price
$admin_fee = 2500;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "INSERT INTO tennis_booking (booking_date, booking_time, field, customer_name, customer_phone, customer_email, team_name, notes, status)
        ...
        <div class="col-lg-8 mb-4">
          <div class="custom-card shadow-sm">
            ...
            <div class="card-body p-4">
              ...
              <form method="POST" action="konfirmasi_pembayaran_tennis.php">
